...
int main(int argc, char** argv){
  ...
  interpolator_pack._partition_spacing[2] = performance_model::parameter_range_partition::SINGLE;
  extrapolator_pack._partition_spacing[1] = performance_model::parameter_range_partition::SINGLE;
  extrapolator_pack._partition_spacing[2] = performance_model::parameter_range_partition::SINGLE;
