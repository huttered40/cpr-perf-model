...
void get_dataset(const char* dataset_file_path, int order, std::vector<double>& configurations, std::vector<double>& runtimes){
  ...
  while (getline(my_file,temp_num,',')){
    ...
    for (int i=0; i<6; i++) getline(my_file,temp_num,',');
    getline(my_file,temp_num,',');
...
int main(int argc, char** argv){
  ...
  interpolator_pack._partition_spacing[0] = performance_model::parameter_range_partition::SINGLE;
  interpolator_pack._partition_spacing[1] = performance_model::parameter_range_partition::SINGLE;
  interpolator_pack._partition_spacing[3] = performance_model::parameter_range_partition::UNIFORM;
  interpolator_pack._partition_spacing[4] = performance_model::parameter_range_partition::SINGLE;
  interpolator_pack._partition_spacing[5] = performance_model::parameter_range_partition::SINGLE;
  extrapolator_pack._partition_spacing[0] = performance_model::parameter_range_partition::SINGLE;
  extrapolator_pack._partition_spacing[1] = performance_model::parameter_range_partition::SINGLE;
  extrapolator_pack._partition_spacing[3] = performance_model::parameter_range_partition::SINGLE;
  extrapolator_pack._partition_spacing[4] = performance_model::parameter_range_partition::SINGLE;
  extrapolator_pack._partition_spacing[5] = performance_model::parameter_range_partition::SINGLE;
