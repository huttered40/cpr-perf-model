...
However, results generated by launching all of these jobs must be parsed using additional scripts that we do not provide.
The subdirectory names match the corresponding figure in the paper.
