...
if __name__ == "__main__":
	...
	mars_model = pe.Earth(max_degree=model_parameters[0],allow_linear=False)#,smooth=True))
        ...
        joblib.dump(mars_model, "MARS.joblib") 
        model_size = os.path.getsize('MARS.joblib')
    ...
    print("What the hell is this - ", np.average(np.absolute(np.asarray(prediction_errors[0]))))
    """
