...
def main(args):
    ...
    et_model = ExtraTreesRegressor(n_estimators=args.ntrees, max_depth=args.tree_depth,random_state=0)
    ...
    for k in range(test_set_size):
        ...
        model_predictions.append(inverse_transform_response(args.response_transform_type,et_model.predict([configuration])[0]))
