...
def main(args):
    ...
    knn_model = KNeighborsRegressor(n_neighbors=args.nneighbors,weights='distance')
    ...
    for k in range(test_set_size):
        ...
        model_predictions.append(inverse_transform_response(args.response_transform_type,knn_model.predict([configuration])[0]))
    ...
    write_statistics_to_file(args.output_file,test_error_metrics,training_error_metrics,timers,[training_set_size,test_set_size],model_size,[args.nneighbors],["model:num_neighbors"])    
