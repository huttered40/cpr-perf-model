...
def main(args):
    ...
    svm_model = SVR(kernel=args.kernel_id,degree=args.max_spline_degree,C=1.0)#, epsilon=0.2)
    ...
    for k in range(test_set_size):
        ...
        model_predictions.append(inverse_transform_response(args.response_transform_type,svm_model.predict([configuration])[0]))
